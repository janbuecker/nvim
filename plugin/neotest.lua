...
--         if ev.data.spec.name == "neotest-golang" and ev.data.spec.kind ~= "deleted" then
--             vim.notify(ev.data.spec.name .. " has been updated. Installing gotestsum...")
...
-- vim.keymap.set("n", "<leader>ta", function() require("neotest").run.run(vim.uv.cwd()) end, {desc = "Run All Test Files" } )
...
-- vim.keymap.set("n", "<leader>tc", function() require("neotest").run.stop() end, {desc = "Stop" } )
